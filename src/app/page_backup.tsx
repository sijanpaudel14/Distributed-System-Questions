...
import { loadQuestions, loadSyllabus, filterQuestions, getUniqueYears } from '@/utils/dataLoader';
...
export default function Home() {
  ...
  const handleSubchapterSelect = (unit: number, chapter: number, subchapter: string) => {
    setFilters(prev => ({
      ...prev,
      selectedUnit: unit,
      selectedChapter: chapter,
...
}filterQuestions, getUniqueYears } from '@/utils/dataLoader';
import Sidebar from '@/components/Sidebar';
import SearchFilters from '@/components/SearchFilters';
import QuestionsList from '@/components/QuestionsList';
import MobileNavigation from '@/components/MobileNavigation';
